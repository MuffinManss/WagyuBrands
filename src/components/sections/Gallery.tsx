...
const images = [
  {
    src: '/images/macarune-character.png',
    alt: 'Macarune character illustration',
    tag: 'Characters',
    unoptimized: false,
    aspect: 'aspect-square',
  },
  {
    src: '/images/moomaru-sunflowers.gif',
    alt: 'Moomaru in a sunflower field',
    tag: 'Animated',
    unoptimized: true,
    aspect: 'aspect-[3/4]',
  },
  {
    src: '/images/macarune-sushi.gif',
    alt: 'Macarune eating sushi',
    tag: 'Animated',
    unoptimized: true,
    aspect: 'aspect-square',
  },
  {
    src: '/images/moomaru-void.gif',
    alt: 'Moomaru floating in the void',
    tag: 'Animated',
    unoptimized: true,
    aspect: 'aspect-[3/4]',
  },
  {
    src: '/images/moomaru-macarune-scene.jpeg',
